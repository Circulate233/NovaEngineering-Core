        ...
        Arrays.stream(OreDictionary.getOreNames())
              ...
              .forEach(oreName -> {
                  ...
                  if (!ores.isEmpty() && !oreName.equals("rawOreAluminium")) {
                      ItemStack stack = ores.getFirst().copy();
